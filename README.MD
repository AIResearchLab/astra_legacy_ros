...
● Please refer to the official [ROS 2 Foxy installation guide](https://docs.ros.org/en/foxy/Installation/Ubuntu-Install-Debians.html)
...
```bash
cd ~/src/astra_legacy_ros/astra_camera/scripts
